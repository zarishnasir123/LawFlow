      ...
      >
        ...
        <div className="mb-6 rounded-md bg-red-50 p-4">
          <p className="text-sm text-gray-700 mb-3">
            <strong>Warning:</strong> Deactivating your registrar account does
            the following:
          </p>
          <ul className="text-sm text-gray-600 space-y-2 ml-4 list-disc">
            <li>You will be signed out of every device immediately</li>
            <li>You will lose access to the registrar dashboard until an admin reactivates you</li>
            <li>
              You have <strong>30 days</strong> to recover the account — just sign
              back in with the same credentials and it will be silently reactivated
            </li>
            <li>
              After 30 days the account is{" "}
              <strong>permanently deleted</strong> the next time anyone tries to
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Type <span className="font-semibold text-red-600">DEACTIVATE</span> to confirm
          </label>
          <input
            type="text"
            value={confirmText}
