...
export default function ReviewCases() {
  ...
  // FIX: Ye function ab Schedule Hearing page par bhejay ga
          ...
          {!action ? (
            ...
            <div className="text-center space-y-4">
               <div className="flex flex-col items-center gap-2">
                  ...
                  <h3 className="font-bold text-gray-800">Approve This Case?</h3>
                  <p className="text-sm text-gray-500">This case will be approved and you will be redirected to schedule the hearing.</p>
               </div>
               <div className="flex gap-3 justify-center pt-2">
                 <button onClick={() => setAction(null)} className="px-6 py-2 border rounded-md text-sm font-medium text-gray-600 hover:bg-gray-50">Cancel</button>
                 {/* FIXED: navigate target changed to schedule-hearing */}
                 <button onClick={handleConfirmApproval} className="px-6 py-2 bg-green-600 text-white rounded-md text-sm font-medium hover:bg-green-700 shadow-md">
