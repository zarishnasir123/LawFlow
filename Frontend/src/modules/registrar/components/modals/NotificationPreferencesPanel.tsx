...
const PREFERENCES_KEY = ["registrar", "notification-preferences"] as const;
...
// The registrar's only optional email is the "new case awaiting review" alert,
// so the settings view exposes just the "case" category. Hearings are created
// by the registrar (not received), and there are no chat/payment emails for them.
const CATEGORIES: Array<{
...
}> = [
  {
    ...
    description: "When a case is submitted to your tehsil",
    icon: AlertCircle,
  },
];
...
// own). Controls which EMAILS the registrar receives; the in-app bell always
// shows everything. On save it returns to the list via onSaved.
