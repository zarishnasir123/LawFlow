        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Define your consultation and document preparation fees for
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-green-50 to-green-100 px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                {civilCharges.length} of {CIVIL_CASE_TYPES.length} case types
                defined
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                {familyCharges.length} of {FAMILY_CASE_TYPES.length} case types
                defined
              </p>
            </div>
