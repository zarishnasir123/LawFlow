...
export default function Signatures() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setError(null);
    // Two fetches in parallel — pending populates the inbox, history
    // populates the activity log. A history failure alone doesn't
    // block the pending list (caught inline).
    Promise.all([
