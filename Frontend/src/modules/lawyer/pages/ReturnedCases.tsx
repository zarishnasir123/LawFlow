          ...
          <div className="mb-6 bg-white border border-red-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-red-600">{returnedCases.length}</p>
              </div>
                ...
                >
                  ...
                  <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-red-800 text-sm mt-1">{caseItem.returnedReason}</p>
                  ...
                  <div className="mb-6 pb-4 border-b border-gray-200">
                    <div className="mb-2">
                      <h3 className="text-xl font-bold text-gray-900">{caseItem.caseTitle}</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-semibold ml-7">{caseItem.clientName}</p>
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-semibold ml-7">{caseItem.filedDate}</p>
                      <p className="text-gray-600 text-sm font-medium mt-3 mb-2">Progress</p>
                      <div className="ml-7">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm font-medium mt-3 mb-2">Case Fee</p>
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button
                      onClick={() =>
                        alert(`Contact registered on: ${caseItem.clientPhone}`)
                      }
            ...
            <div className="bg-white rounded-lg shadow-2xl max-w-md w-full md:max-w-2xl">
              ...
              <div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                ...
                <button
                  onClick={() => {
                    alert(
                      `Case ${resubmitModal.caseTitle} marked for resubmission. Documents will be reviewed.`
                    );
