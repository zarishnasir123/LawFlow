          ...
          <div className="space-y-8">
              ...
              {caseTypes.map((caseType) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    {selectedCaseType?.id === caseType.id && (
                      <div
                        className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-1 transform transition ${
                          category === "civil"
                            ? "bg-green-600"
                            : "bg-purple-600"
                        }`}
            ...
            {selectedCaseType && (
              <div className="flex gap-4 pt-6 border-t-2 border-gray-200">
                <button
                  onClick={reset}
                  className="flex-1 px-6 py-3 rounded-xl border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-400 transition duration-300"
                >
                  Cancel
                </button>
                <button
                  ...
                  className={`flex-1 px-6 py-3 rounded-xl text-white font-semibold transition duration-300 transform hover:scale-105 ${
                    category === "civil"
