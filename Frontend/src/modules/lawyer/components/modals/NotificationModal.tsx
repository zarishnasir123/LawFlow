...
export default function NotificationModal({
  ...
  // Mark read, then route to the notification's target (its actionUrl, or the
  // case editor when it's a case-bound row), closing the drawer.
                ...
                <div className="flex h-full flex-col items-center justify-center px-6 text-center">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    {filter === "unread"
                      ...
                      : "Updates about your cases, hearings, and payments will show up here."}
                  </p>
                </div>
              ) : (
