...
// allow-list. Used so the admin only types digits — the "+92-" prefix and the
// CNIC dashes are inserted automatically. The backend stays the authoritative
// gate; isAllowedGujranwalaCnic just gives instant client-side feedback.
